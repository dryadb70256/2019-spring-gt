...
{ 
	ofstream op;
	op.open("Chinese postman path.txt");
    ...
    { 
		switch(circuit[i])
		{
			case 0: cout << "a";  op<<"a"; break;
			case 1: cout << "b";  op<<"b";  break;
			case 2: cout << "c";  op<<"c";  break;
			case 3: cout << "d";  op<<"d";  break;
			case 4: cout << "e";  op<<"e";  break;
			case 5: cout << "f";  op<<"f";  break;
			case 6: cout << "g";  op<<"g";  break;
			case 7: cout << "h";  op<<"h";  break;
			case 8: cout << "i";  op<<"i";  break;
			case 9: cout << "j";  op<<"j";  break;
			case 10:cout << "k";  op<<"k";  break;
			case 11:cout << "l";  op<<"l";  break;
			case 12:cout << "m";  op<<"m";  break;
			case 13:cout << "n";  op<<"n";  break;
			case 14:cout << "o";  op<<"o";  break;
			case 15:cout << "p";  op<<"p";  break;
			case 16:cout << "q";  op<<"q";  break;
			case 17:cout << "r";  op<<"r";  break;
			case 18:cout << "s";  op<<"s";  break;
			case 19:cout << "t";  op<<"t";  break;
			case 20:cout << "u";  op<<"u";  break;
			case 21:cout << "v";  op<<"v";  break;
			case 22:cout << "w";  op<<"w";  break;
			case 23:cout << "x";  op<<"x";  break;
			case 24:cout << "y";  op<<"y";  break;
			case 25:cout << "z";  op<<"z";  break;
